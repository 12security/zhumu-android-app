...
public final class y {
    ...
    public y(Context context, b bVar, a aVar, com.tencent.bugly.legu.crashreport.common.info.a aVar2, BuglyStrategy.a aVar3) {
        this.a = context;
        this.b = bVar;
        this.c = aVar;
        this.d = aVar2;
     ...
     */
    public final void a(Thread thread, int i, String str, String str2, String str3) {
        w.e("Cocos2d-x Crash Happen", new Object[0]);
        this.c.c();
        if (!this.c.b()) {
        ...
        if (!c2.d && this.c.b()) {
            ...
            b.a("Cocos2dx", a.n(), this.d.d, thread, str + "\n" + str2 + "\n" + str3, null);
            w.e("handle end", new Object[0]);
        } else if (!c2.h) {
